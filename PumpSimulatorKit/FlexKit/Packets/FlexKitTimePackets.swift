...
enum FlexKitTimePackets {
    static let logger = PumpManagerLogger(subsystem: "com.bastiaanv.flexkit", category: "FlexKitTimePackets")
    ...
    private static func applyTimeUpdate(_ payload: Data, _ params: FlexKitBluetoothManager.PacketParams) {
    ...
    private static func sendReadResponse(_ params: FlexKitBluetoothManager.PacketParams) {
        var response = Data()
